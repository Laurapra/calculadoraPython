...
boton0 = Button(ventana, text="0", width=13, height=2, command= lambda: click_buton(0))

boton_borrar = Button(ventana, text="AC", width=5, height=2, command= lambda: borrar())
boton_parentesis1 = Button(ventana, text="(", width=5, height=2, command= lambda: click_buton("("))
boton_parentesis2 = Button(ventana, text=")", width=5, height=2, command= lambda: click_buton(")"))
boton_punto = Button(ventana, text=".", width=5, height=2, command= lambda: click_buton("."))

boton_div = Button(ventana, text="/", width=5, height=2, command= lambda: click_buton("/"))
boton_multiplicacion = Button(ventana, text="*", width=5, height=2, command= lambda: click_buton("*"))
boton_suma = Button(ventana, text="+", width=5, height=2, command= lambda: click_buton("+"))
boton_resta = Button(ventana, text="-", width=5, height=2, command= lambda: click_buton("-"))
